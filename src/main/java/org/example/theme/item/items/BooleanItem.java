...
public class BooleanItem extends ExtendableItem {
    ...
    public void render(RenderContext context, double mouseX, double mouseY) {
        ...
        renderer.drawRectangle(getX()-1, getY()-1, getWidth()+1, getHeight()+1, new Color(0, 0, 0, 70).getRGB());
        ...
        fontRenderer.drawText(fontRenderer.trimStringToWidth(setting.getDisplayName(), getWidth()), getX() + 1, getY() + 1.5, setting.getValue() ? ExamplePlugin.theme.getColorSetting().getValueRGB() : ExamplePlugin.theme.fontColor.getValueRGB(), getWidth(), 1);
