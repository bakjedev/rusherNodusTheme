...
public class BindItem extends ExtendableItem{
    ...
    public void render(RenderContext context, double mouseX, double mouseY) {
        ...
        if (isListening) {
            fontRenderer.drawText(fontRenderer.trimStringToWidth(setting.getDisplayValue() + ": Waiting" + getIdleSign(), getWidth() - 2), getX() + 1, getY() + 1, ExamplePlugin.theme.getColorSetting().getValueRGB(), getWidth(), 1);
        } else {
