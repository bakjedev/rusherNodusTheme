...
public class ModuleItem extends ExtendableItem {
    ...
    public void render(RenderContext context, double mouseX, double mouseY) {
        ...
        if(module instanceof ToggleableModule && ((ToggleableModule) module).isToggled()) {
            fontRenderer.drawText(module.getName(), getX() + 3.5f, getY() + 1f,
                    ExamplePlugin.theme.getColorSetting().getValue().getRGB(), getWidth(), 1);
        } else {
            fontRenderer.drawText(module.getName(), getX() + 3.5f, getY() + 1f,
